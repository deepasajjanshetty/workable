---
title: Installation
description: Getting started with workable
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://workableui.vercel.app/r/utils.json 
```

```bash tab="npx"
npx shadcn@latest add https://workableui.vercel.app/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://workableui.vercel.app/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://workableui.vercel.app/r/card-05.json
```

```bash tab="npx"
npx shadcn@latest add https://workableui.vercel.app/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://workableui.vercel.app/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://workableui.vercel.app/r/ai-card-generation.json
```
```bash tab="npx"
npx shadcn@latest add https://workableui.vercel.app/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://workableui.vercel.app/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/workable/blocks/ai-card-generation/ai-card-generation";
...
```bash tab="bun"
bunx shadcn@latest add https://workableui.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="npx"
npx shadcn@latest add https://workableui.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://workableui.vercel.app/r/card-05.json -c ./apps/www
```
