...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched Workable! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "Workable Documentation",
            description: "A comprehensive guide to Workable",
