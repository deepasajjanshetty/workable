...
import { Btn14 } from "../workable/button/btn-14";
import Btn03 from "../workable/button/btn-03";
import Input09 from "../workable/input/input-09";
import AIInput_04 from "../workable/ai-input/ai-input-04";

import Card08 from "../workable/card/card-08";
import { BrowseBlocksButton } from "../ui/browse-blocks";
import { BrowseComponentsButton } from "../ui/browse-button";
import Features from "./feature-block";

import Card02 from "../workable/card/card-02";
      ...
      <div className="w-full lg:w-[45%] flex flex-col items-start text-left space-y-8">
        ...
        >
          ...
          <p className="mt-6 text-base md:text-xl text-zinc-700 dark:text-zinc-300 max-w-lg">
            Your personal toolkit of{" "}
            <span className="font-semibold">100+ production-ready components</span>{" "}
            built with{" "}
            ...
            for your React and Next.js projects.
          </p>
        </motion.div>
